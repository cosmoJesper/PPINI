...
load mc_source_Pulu.mat                        % Load file with sink simulations
name = 'mc_sink_Pulu';                                 % Filename for saving
file = 'Zhao.xlsx';
...
elev = 2500;                                           % Elevation of sampling site [m asl.]

%*********** Sink history ************
min_sink_time = 0.5;                                  % Possible burial times in sink [Myr]         
...
starting_depth = 2000;                                % Estimated starting depth of sample [g/cm2]

%*********** Other info **************
P_SLHL = 4;                                           % 10Be production sea-level high-latitude [at/g/yr]
R = 6.8;                                             % 26Al/10Be production ratio at sea-level high-latitude
...
figure;
    ...
    subplot(1,3,1)
        ...
        xlabel('Total ^1^0Be production [at/g/yr]')
        ylabel('Depth [10^4 g/cm2]')
        legend('Balco2017','Balco2017 fit','Heisinger2002','location','southeast')
        yticks([0 0.5 1 1.5 2]*1e4)
    ...
    subplot(1,3,2)
        ...
        set(gca,'XScale','log')
        set(gca,'YDir','reverse')
        xlabel('Total ^2^6Al production [at/g/yr]')
        ylabel('Depth [10^4 g/cm2]')
        legend('Balco2017','Balco2017 fit','Heisinger2002','location','southeast')
        yticks([0 0.5 1 1.5 2]*1e4)
        yticklabels({'0','0.5','1','1.5','2'})
