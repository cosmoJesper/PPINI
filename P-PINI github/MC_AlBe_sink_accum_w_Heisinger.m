...
max_sink_time = 14;                                   % Possible burial times in sink [Myr]
min_accum_rate = 0;                                   % Possible erosion rates in sink [g/cm2/yr]
max_accum_rate = 50000;                               % Possible erosion rates in sink [g/cm2/yr]
...
accums = 1*linspace(min_accum_rate,max_accum_rate,Ne)*1e-6;                 % Possible erosion rates in sink [g/cm2/yr]
