...
leg_str = {'1 in 1000 of simulations';'Accepted simulations';'Ratio = 6.8'};
if numel(k) > 3
    for i=4:numel(k)
...
for rep = 1:rep_max
    ...
    if  thres_NBe < 0.01 && thres_NAl < 0.01 || thres_age < 0.01 && thres_e < 0.01
...
figure(1)
set(gcf,'Units','normalized','position',[0.4911 0.3611 0.3646 0.5250]);
...
figure(3)
set(gcf,'Units','normalized','position',[0.1615 0.3620 0.3271 0.5231]);
ax = gca;
ax.TickLength = [0.01 0.01];
