...
file = 'Zhao.xlsx';                                  % Name of excelfile in sample folder
...
max_accum_rate = 10000;                                 % Possible erosion rates in sink [g/cm2/Myr]
...
z = linspace(0,min([1.9e5 round(max(accums)*max(sink_time)+starting_depth,-1)]),1000);
