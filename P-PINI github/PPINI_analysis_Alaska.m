...
site = ' ';
name = 'mc_sink_Alaska';    % Library name 
file = 'Alaska2.xlsx';      % Excel sheet with sample information
...
ax = gca;
leg2(3) = plot(ax.XLim,ax.XLim*6.97,'-k');
leg_str = {'1 in 1000 of simulations';'Accepted simulations';'Ratio = 6.97'};
...
subplot(2,2,1)
set(gca,'XTick',[],'YTickLabel',[0 0.5 1 1.5 2])
ylabel('10^4 g/cm2/Myr')
subplot(2,2,2)
set(gca,'XTick',[], 'YTick', [])
subplot(2,2,3)
