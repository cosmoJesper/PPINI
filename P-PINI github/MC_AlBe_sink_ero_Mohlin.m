...
min_erate = 0;      % Possible erosion rates in sink [m/yr]
max_erate = 100;        % Possible erosion rates in sink [m/yr]
...
erates = 1*linspace(min_erate,max_erate,Ne)*1e-6;                   % Possible erosion rates in sink [m/yr]
