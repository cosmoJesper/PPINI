...
T = readtable('Zhao.xlsx','VariableNamingRule','preserve');
...
xticks([0 0.5 1 1.5 2 2.5 3]*1e5)
xticklabels({'0','0.05','0.1','0.15','0.2','0.25','0.3'})
yticks([0 0.2 0.4 0.6 0.8 1 1.2]*1e6)
yticklabels({'0','0.2','0.4','0.6','0.8','1','1.2'})
ax =gca; ax.YLim = [0 1.2e6];
...
simple_figure()
h = text(0.122e6,0.9e6,['^2^6P/^1^0P = ',num2str(R)]);
set(h,'Rotation',53);