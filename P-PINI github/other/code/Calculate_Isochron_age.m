...
T = readtable('Laaerberg.xlsx','VariableNamingRule','preserve');
...
lat = 48.17;                                                      % Latitude of sink site
lon = 16.38;                                                      % Longitude of sink site
elev = 219;                                           % Elevation of sampling site [m asl.]
R = 6.97;
...
% yticks([0 0.2 0.4 0.6 0.8 1 1.2 1.4 1.6 1.8 2.0]*1e5)
