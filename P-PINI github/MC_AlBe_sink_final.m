...
file = 'Alaska2.xlsx';                                  % Name of excelfile in sample folder

%********** Accumulation or erosion ************
ero = 1;  % Enter 1 for erosino, 0 for accumulation
...
max_sink_time = 12;                                      % Possible burial times in sink [Myr]
...
depth = 100000;                                         % IF ACCUMULATION: Input estimated depth of samples within unit [g/cm2]
